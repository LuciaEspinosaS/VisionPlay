...
/**
 * Caso de uso que realiza una búsqueda en la API de las plataformas en las que se encuentra una película
 *
...
class DiscoverMovieProviderUseCase {
     ...
     *
     * @param movie_id identificador de la película o serie
     *
